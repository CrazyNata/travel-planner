...
Статус: не отправлять как готовый ответ. Релиз `0.2.66` (version code `10204`) находится в закрытом тестировании; на 15 сентября 2026 Play Console показывает 12 участников и 10 дней тестирования. Заявка на production access пока заблокирована до выполнения 14 дней.
