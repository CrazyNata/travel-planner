...
final class IOSCityCatalogRepository {
    private let entries: [IOSCityCatalogEntry] = [
        IOSCityCatalogRepository.city("prague", "Прага", "Prague", "Praga", "Prag", 50.0755, 14.4378, "🇨🇿", "прага", "praha"),
        IOSCityCatalogRepository.city("salzburg", "Зальцбург", "Salzburg", "Salzburgo", "Salzburg", 47.8095, 13.0550, "🇦🇹"),
        IOSCityCatalogRepository.city("verona", "Верона", "Verona", "Verona", "Verona", 45.4384, 10.9916, "🇮🇹"),
        IOSCityCatalogRepository.city("rome", "Рим", "Rome", "Roma", "Rom", 41.9028, 12.4964, "🇮🇹"),
        IOSCityCatalogRepository.city("pisa", "Пиза", "Pisa", "Pisa", "Pisa", 43.7228, 10.4017, "🇮🇹"),
        IOSCityCatalogRepository.city("san-marino", "Сан-Марино", "San Marino", "San Marino", "San Marino", 43.9424, 12.4578, "🇸🇲"),
        IOSCityCatalogRepository.city("chioggia", "Кьоджа", "Chioggia", "Chioggia", "Chioggia", 45.2181, 12.2786, "🇮🇹"),
        IOSCityCatalogRepository.city("milan", "Милан", "Milan", "Milán", "Mailand", 45.4642, 9.1900, "🇮🇹"),
        IOSCityCatalogRepository.city("munich", "Мюнхен", "Munich", "Múnich", "München", 48.1351, 11.5820, "🇩🇪", "muenchen"),
        IOSCityCatalogRepository.city("vienna", "Вена", "Vienna", "Viena", "Wien", 48.2082, 16.3738, "🇦🇹"),
        IOSCityCatalogRepository.city("innsbruck", "Инсбрук", "Innsbruck", "Innsbruck", "Innsbruck", 47.2692, 11.4041, "🇦🇹"),
        IOSCityCatalogRepository.city("florence", "Флоренция", "Florence", "Florencia", "Florenz", 43.7696, 11.2558, "🇮🇹"),
        IOSCityCatalogRepository.city("venice", "Венеция", "Venice", "Venecia", "Venedig", 45.4408, 12.3155, "🇮🇹"),
        IOSCityCatalogRepository.city("tallinn", "Таллин", "Tallinn", "Tallin", "Tallinn", 59.4370, 24.7536, "🇪🇪"),
        IOSCityCatalogRepository.city("riga", "Рига", "Riga", "Riga", "Riga", 56.9496, 24.1052, "🇱🇻"),
        IOSCityCatalogRepository.city("vilnius", "Вильнюс", "Vilnius", "Vilna", "Vilnius", 54.6872, 25.2797, "🇱🇹"),
        IOSCityCatalogRepository.city("como", "Комо", "Como", "Como", "Como", 45.8080, 9.2600, "🇮🇹", "озеро комо", "lake como"),
        IOSCityCatalogRepository.city("bormio", "Бормио", "Bormio", "Bormio", "Bormio", 46.4670, 10.3740, "🇮🇹"),
        IOSCityCatalogRepository.city("berlin", "Берлин", "Berlin", "Berlín", "Berlin", 52.5200, 13.4050, "🇩🇪"),
        IOSCityCatalogRepository.city("amsterdam", "Амстердам", "Amsterdam", "Ámsterdam", "Amsterdam", 52.3676, 4.9041, "🇳🇱"),
        IOSCityCatalogRepository.city("barcelona", "Барселона", "Barcelona", "Barcelona", "Barcelona", 41.3874, 2.1686, "🇪🇸"),
        IOSCityCatalogRepository.city("madrid", "Мадрид", "Madrid", "Madrid", "Madrid", 40.4168, -3.7038, "🇪🇸"),
        IOSCityCatalogRepository.city("lisbon", "Лиссабон", "Lisbon", "Lisboa", "Lissabon", 38.7223, -9.1393, "🇵🇹"),
        IOSCityCatalogRepository.city("paris", "Париж", "Paris", "París", "Paris", 48.8566, 2.3522, "🇫🇷"),
        IOSCityCatalogRepository.city("london", "Лондон", "London", "Londres", "London", 51.5074, -0.1278, "🇬🇧"),
        IOSCityCatalogRepository.city("budapest", "Будапешт", "Budapest", "Budapest", "Budapest", 47.4979, 19.0402, "🇭🇺"),
        IOSCityCatalogRepository.city("istanbul", "Стамбул", "Istanbul", "Estambul", "Istanbul", 41.0082, 28.9784, "🇹🇷", "стамбул"),
        IOSCityCatalogRepository.city("zurich", "Цюрих", "Zurich", "Zúrich", "Zürich", 47.3769, 8.5417, "🇨🇭"),
        IOSCityCatalogRepository.city("helsinki", "Хельсинки", "Helsinki", "Helsinki", "Helsinki", 60.1699, 24.9384, "🇫🇮"),
        IOSCityCatalogRepository.city("dubai", "Дубай", "Dubai", "Dubái", "Dubai", 25.2048, 55.2708, "🇦🇪"),
        IOSCityCatalogRepository.city("tokyo", "Токио", "Tokyo", "Tokio", "Tokio", 35.6762, 139.6503, "🇯🇵"),
        IOSCityCatalogRepository.city("new-york", "Нью-Йорк", "New York", "Nueva York", "New York", 40.7128, -74.0060, "🇺🇸", "new york"),
    ]
