...
- Never change the database structure. Do not create, alter, or delete tables, columns, constraints, indexes, relationships, views, functions, triggers, RLS policies, migrations, or other schema objects. Do not run schema pushes, database resets, or migrations.
