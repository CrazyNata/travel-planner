...
const munichDayOneSights: StoredSight[] = [
  { id: "munich-karlsplatz", name: "Karlsplatz (Stachus)", city: "Мюнхен", walkDay: 1, walkOrder: 0, lnglat: [11.5659, 48.1391], duration: "20 мин", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/2268_-_M%C3%BCnchen_-_Karlsplatz.JPG/960px-2268_-_M%C3%BCnchen_-_Karlsplatz.JPG", description: "Оживлённая площадь у западного входа в исторический центр Мюнхена." },
  { id: "munich-neuhauser", name: "Neuhauser Straße", city: "Мюнхен", walkDay: 1, walkOrder: 1, lnglat: [11.5685, 48.1385], duration: "30 мин", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/%C3%96KT_Neuhauserstr.jpg/960px-%C3%96KT_Neuhauserstr.jpg", description: "Пешеходная улица с рождественскими витринами, гирляндами и праздничными украшениями." },
  { id: "munich-karlstor", name: "Karlstor", city: "Мюнхен", walkDay: 1, walkOrder: 2, lnglat: [11.5656, 48.1389], duration: "15 мин", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/Karlstor_-_Munich.JPG/960px-Karlstor_-_Munich.JPG", description: "Средневековые городские ворота, открывающие путь в Старый город." },
  { id: "munich-marienplatz", name: "Marienplatz", city: "Мюнхен", walkDay: 1, walkOrder: 3, lnglat: [11.5755, 48.1374], duration: "30 мин", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Rathaus_and_Marienplatz_from_Peterskirche_-_August_2006.jpg/960px-Rathaus_and_Marienplatz_from_Peterskirche_-_August_2006.jpg", description: "Главная площадь Мюнхена и сердце праздничного Старого города." },
  { id: "munich-neues-rathaus", name: "Новая ратуша (Neues Rathaus)", city: "Мюнхен", walkDay: 1, walkOrder: 4, lnglat: [11.5756, 48.1376], duration: "30 мин", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Neues_Rathaus_M%C3%BCnchen_2018.jpg/960px-Neues_Rathaus_M%C3%BCnchen_2018.jpg", description: "Неоготическая ратуша с башней, часами и знаменитым Глокеншпилем." },
  { id: "munich-christkindlmarkt", name: "Christkindlmarkt", city: "Мюнхен", walkDay: 1, walkOrder: 5, lnglat: [11.5752, 48.1372], duration: "1,5 ч", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/WeihnachtsmarktMuenchen.jpg/960px-WeihnachtsmarktMuenchen.jpg", description: "Главная рождественская ярмарка города с ремесленными лавками и баварскими угощениями." },
  { id: "munich-frauenkirche", name: "Frauenkirche", city: "Мюнхен", walkDay: 1, walkOrder: 6, lnglat: [11.5734, 48.1386], duration: "30 мин", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Frauenkirche_Munich_-_View_from_Peterskirche_Tower2.jpg/960px-Frauenkirche_Munich_-_View_from_Peterskirche_Tower2.jpg", description: "Кафедральный собор и один из главных архитектурных символов Мюнхена." },
  { id: "munich-kaufingerstrasse", name: "Kaufingerstraße", city: "Мюнхен", walkDay: 1, walkOrder: 7, lnglat: [11.5712, 48.1379], duration: "30 мин", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Kaufingerstra%C3%9Fe_2014-08-02.JPG/960px-Kaufingerstra%C3%9Fe_2014-08-02.JPG", description: "Праздничная торговая улица, особенно красивая в вечерней подсветке." },
  { id: "munich-residenz-weihnachtsdorf", name: "Residenz Weihnachtsdorf", city: "Мюнхен", walkDay: 1, walkOrder: 8, lnglat: [11.5784, 48.1411], duration: "1 ч", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Aerial_image_of_Munich_Residenz.jpg/960px-Aerial_image_of_Munich_Residenz.jpg", description: "Уютная рождественская деревня во дворе Мюнхенской резиденции." },
  { id: "munich-max-joseph-platz", name: "Max-Joseph-Platz", city: "Мюнхен", walkDay: 1, walkOrder: 9, lnglat: [11.5789, 48.1398], duration: "20 мин", photo: "https://upload.wikimedia.org/wikipedia/commons/e/e6/Nationaltheater_Muenchen.jpg", description: "Парадная площадь перед Баварской государственной оперой и Резиденцией." },
  { id: "munich-odeonsplatz", name: "Odeonsplatz", city: "Мюнхен", walkDay: 1, walkOrder: 10, lnglat: [11.5777, 48.1421], duration: "25 мин", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Odeonsplatz2%2C_M%C3%BCnchen.jpg/960px-Odeonsplatz2%2C_M%C3%BCnchen.jpg", description: "Монументальная площадь на границе Старого города и дворцового квартала." },
  { id: "munich-feldherrnhalle", name: "Feldherrnhalle", city: "Мюнхен", walkDay: 1, walkOrder: 11, lnglat: [11.5778, 48.1424], duration: "15 мин", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Feldherrnhalle_M%C3%BCnchen.jpg/960px-Feldherrnhalle_M%C3%BCnchen.jpg", description: "Аркада XIX века, вдохновлённая флорентийской Лоджией Ланци." },
  { id: "munich-theatinerkirche", name: "Theatinerkirche", city: "Мюнхен", walkDay: 1, walkOrder: 12, lnglat: [11.5768, 48.1422], duration: "25 мин", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Exterior_of_Theatinerkirche%2C_Munich.jpg/960px-Exterior_of_Theatinerkirche%2C_Munich.jpg", description: "Барочная церковь с выразительным жёлтым фасадом и красивой вечерней подсветкой." },
  { id: "munich-hofgarten", name: "Hofgarten", city: "Мюнхен", walkDay: 1, walkOrder: 13, lnglat: [11.5808, 48.1426], duration: "30 мин", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/M%C3%BCnchen_Hofgartentempel.jpg/960px-M%C3%BCnchen_Hofgartentempel.jpg", description: "Спокойный придворный сад рядом с Резиденцией, завершающий прогулку." },
];
  ...
  return (
    <div>
      ...
      <main className="workspace">
        ...
        {tab === "sights" && <><Sights sights={tripSights} days={sightDays} defaultCity={trip.cities.split(",")[0]?.trim()} onToggle={(id) => { const sight = tripSights.find((item) => item.id === id); const isCheckbox = document.activeElement instanceof HTMLInputElement && document.activeElement.type === "checkbox"; if (isCheckbox) { onUpdateTrip({ ...trip, sights: tripSights.map((item) => item.id === id ? { ...item, done: !item.done } : item) }); return; } if (!sight) return; window.dispatchEvent(new CustomEvent("odyssey-focus-sight", { detail: id })); window.open(`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${sight.name}, ${sight.city}`)}`, "_blank", "noopener,noreferrer"); }} onAdd={(sight) => onUpdateTrip({ ...trip, sights: [...tripSights, sight] })} onAddDay={(title) => onUpdateTrip({ ...trip, sightDaysVersion: 1, sightDays: [...sightDays, { id: crypto.randomUUID(), title }] })} onRenameDay={(id, title) => onUpdateTrip({ ...trip, sightDaysVersion: 1, sightDays: sightDays.map((day) => day.id === id ? { ...day, title } : day) })} /><SightNotes value={trip.sightNotes?.[sightDays[0].id] || (trip.title.toLowerCase().includes("рождествен") ? munichDayOneNotes : "")} onChange={(value) => onUpdateTrip({ ...trip, sightNotes: { ...trip.sightNotes, [sightDays[0].id]: value } })} /></>}
