...
const munichDayOneSights: StoredSight[] = [
  ...
  { id: "munich-karlstor", name: "Karlstor", city: "Мюнхен", walkDay: 1, walkOrder: 2, lnglat: [11.5656, 48.1389], duration: "15 мин", photo: "https://upload.wikimedia.org/wikipedia/commons/0/0b/Steinlein_24.jpg", description: "Средневековые городские ворота, открывающие путь в Старый город." },
